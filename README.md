...
Basis: Serverless ToDo Project 
Adapted to use every other items instead. This could be a wish list or a bucket list. 

Note: The client has not been adapted. Hence, it might still be some entries with the name todos. 

# Functionality of the application

This application will allow creating/removing/updating/fetching any kind of items you want. Each item can optionally have an attachment image. Each user only has access to items that he/she has created.
